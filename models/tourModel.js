...
const tourSchema = new mongoose.Schema(
  {
    ...
    difficulty: {
      ...
      enum: {
        ...
        message: 'Diffculty either easy,medium,diffculy'
      }
    },
    ...
    priceDiscount: {
      ...
      validate: {
        validator: function(val) {
          ...
          // this will not work for update since it will refer to the original document but not the updated value we are sending during update
